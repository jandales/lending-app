<template>
  <div class="w-full bg-white">
      <div class="flex flex-col  p-4">
        <div class="w-full flex items-center justify-between mb-6">
          <h1 class="tracking-wider text-lg">Loans Reports</h1> 
  ...
  <div v-if="loans.length > 0" class="mt-4 border border-l-0 border-r-0 bg-white">
          ...
          <table class="min-w-full">
            ...
            <tbody>  
              ...
              <tr v-if="loans.length > 0" v-for="loan in loans" class="bg-white border-b transition duration-300 ease-in-out last:border-b-0 hover:bg-gray-100"> 
                <td class="text-gray-90 text-sm  font-light px-6 py-4 whitespace-nowrap">
                     {{ loan.loan_number }}
                </td>       
...
<script setup>
  ...
  const { exportLoans, reportLoanToPDF } = useExport();
