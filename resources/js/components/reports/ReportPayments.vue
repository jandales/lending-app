  ...
  <div class="w-full bg-white">
      <div class="flex flex-col  p-4">
        <div class="w-full flex items-center justify-between mb-6">
            <h1 class="tracking-wider text-lg">Payments Report</h1> 
...
<script setup>
  ...
  const { exportPayments, reportPaymentToPDF } = useExport();
  ...
  const exportHandle = async () => {
     await exportPayments({...form});
  }

  const printhandle = async () => {
    await reportPaymentToPDF({...form});
  }
