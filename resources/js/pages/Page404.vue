<template>
    <div class="min-h-screen w-full flex flex-col items-center justify-center">
        ...
        <h1 class="text-gray-500  uppercase text-[2rem]">You're Beyond the Borders</h1>
        <router-link class="btn-primary mt-4 uppercase" :to="{name: 'dashboard'}">Reroute</router-link>
    </div>
</template>